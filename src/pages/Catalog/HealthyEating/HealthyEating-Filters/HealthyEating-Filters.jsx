          ...
          <div className="container">
            <div className="tea-filters__inner">
              <div className="filters__left">
                <ul className="filters-nav">
                  ...
                  <li>
                    <Link className="filters-nav-item" to="/catalog/healthy">
                      &#x2022;Здоровое питание
                    </Link>
                  </li>
                </ul>
                <h1 className="filters__title healthy-title">
                  Здоровое питание
                </h1>
              </div>
            </div>
            ...
            <div className="tea-filters-blocks">
              <div className="tea-filters-blocks-top">
                ...
                >
                  <img
                    src="https://avatars.mds.yandex.net/get-mpic/7660527/img_id6827102340375698673.jpeg/orig"
                    height="182px"
                    alt=""
                  />
                ...
                >
                  <img
                    src="https://avatars.mds.yandex.net/get-mpic/4250892/img_id5980908321901524472.jpeg/orig"
                    height="182px"
                    alt=""
                  />
              ...
              <div className="tea-filters-blocks-bottom">
                ...
                >
                  <img
                    src="https://avatars.mds.yandex.net/get-mpic/4742551/img_id2524634304788013634.jpeg/orig"
                    height="182px"
                    alt=""
                  />
                ...
                >
                  <img
                    src="https://avatars.mds.yandex.net/get-mpic/6269810/img_id7796361350956365479.png/orig"
                    height="182px"
                    alt=""
                  />
                  <p>Толокняные каши</p>
