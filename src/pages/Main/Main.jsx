    ...
    <div className="wrapper">
      ...
      <div className="catalog-products">
        <div className="catalog-inner">
          ...
          <div className="catalog-items"></div>
        </div>
      </div>
        ...
        <div className="roast-coffe-container">
          <div className="roast-coffe-inner">
            ...
            <p>
              ...
              миру. Компания имеет долгосрочные контракты по поставке продукции.
              Каждая партия проходит строгий контроль на заводе для проверки
              зерна. Зеленое зерно обжаривается, проходит процесс дегазации и
              тут же отправляется клиентам. Наши обжарщики прошли обучение в
